...
int display_files(char *folder_name)
{
    ...
    int i=0;
    int j=0;
    n = scandir(folder_name, &name_list,NULL,alphasort);// sort the files name in the directory
    printf("Current Directory:\t%s",getcwd(NULL,0));// prints the current directory
    newline(2);
    tab(5);
